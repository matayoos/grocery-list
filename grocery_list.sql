...
CREATE TABLE `invoice` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_grocery_store` (`grocery_store_id`),
  CONSTRAINT `fk_grocery_store` FOREIGN KEY (`grocery_store_id`) REFERENCES `grocery_store` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `invoice_items` (
  `invoice_id` varchar(88) NOT NULL,
  ...
  CONSTRAINT `invoice_items_ibfk_3` FOREIGN KEY (`category`) REFERENCES `category` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `products` (
  ...
  `grocery_store_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `grocery_store_id` (`grocery_store_id`),
  CONSTRAINT `products_ibfk_1` FOREIGN KEY (`grocery_store_id`) REFERENCES `grocery_store` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-03-08 18:35:26
